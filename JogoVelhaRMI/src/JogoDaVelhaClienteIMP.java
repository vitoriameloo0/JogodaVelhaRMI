...
public class JogoDaVelhaClienteIMP extends JFrame implements JogoDaVelhaClienteInterface {
    ...
    public JogoDaVelhaClienteIMP(String jogadorSimbolo) throws RemoteException {
    ...
    public static void main(String[] args) {
        try {
            new JogoDaVelhaClienteIMP(args[0]); // Passar "X" ou "O" como argumento ao rodar o cliente
